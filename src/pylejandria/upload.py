...
the repository. Version 1.0.7 By Armando Chaparro.
"""
...
class Uploader(tk.Tk):
    """Simplifies the process of uploading the project to GitHub"""
    ...
    def get_version(self) -> None:
        ...
        with open(path, "r", encoding="UTF-8") as file:
            ...
            match self.old_version.split("."):
                case (main, feature, bug):
                    self.version = f"{main}.{feature}.{int(bug) + 1}"
    ...
    def upload(self) -> None:
        ...
        if self.pypi is True:
            ...
            with open(path, mode="w", encoding="UTF-8") as file:
                file.write(self.text.replace(self.old_version, self.version))
    ...
    def run(self) -> None:
        ...
        path_button = tk.Button(self, text="Change", command=self.change_path)
        ...
        version_button = tk.Button(self, text="Validate", command=self.validate_version)
        ...
        upload_button = tk.Button(self, text="Upload", command=self.get_values)
